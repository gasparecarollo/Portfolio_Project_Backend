...
("Parigina", "category", "image_id", "A sheet pan pizza filled with prosciutto, tomatoes,mozzarella, and topped with filo dough (puff pastry) .", 9.50, False, 9), ("Napoleon", "category", "image_id", "A napoleon or mille-feuille is a classic French pastry with layers of buttery, flaky puff pastry baked until golden and crisp, then filled with alternating layers of pastry cream and whipped cream.", 6.75, False,10),
...
("Brioche con Gelato", "category", "image_id", "Brioche con gelato is a traditional Italian dessert hailing from Sicily. This dessert sandwich consists of a soft, buttery brioche bun that's stuffed with a generous amount of gelato.", 7.00, False, 10),
